...
public class Listas {
	...
	public static boolean esSublista(List<Integer> Lista2, List<Integer>Lista1){
	    List<Integer>aux = new ArrayList<Integer>();
	    
	    for(int i=0; i<Lista2.size()-Lista1.size()-1;i++){
	        aux = Lista2.subList(i,Lista1.size()+i);
	        if(aux.equals(Lista1)) { 
	            return true;
	        }
	    }
	    return false;
